...
import 'package:api_bloc_base/src/presentation/bloc/provider/provider_wrapper.dart';
import 'package:api_bloc_base/src/presentation/bloc/user/base_user_bloc.dart';

import '_defs.dart';
import 'lifecycle_observer.dart';
import 'provider_converter.dart';

class SimpleUserProvider<UserType extends BaseProfile<UserType>>
    extends ProviderConverter<UserType, UserType>
  ...
  SimpleUserProvider(this.userBloc, LifecycleObserver appLifecycleObserver)
      : super(
          ProviderWrapper(userBloc.profileStream, onRefreshData: () {
